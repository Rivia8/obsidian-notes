...
Testing on the other hand, in the context of VLSI, it usually refers to **Manufacturing Test**. This happens after the chip is made.
The main goal of testing is to find defects in the silicon.
